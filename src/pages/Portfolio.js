                    ...
                    <div className="col-sm-4 py-2">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <img src={`/dreami-react-portfolio/assets/images/Screen Shot 2020-11-26 at 8.42.51 AM.png`} className="card-img-top" alt="media-made" />
                    ...
                    <div className="col-sm-4 py-2">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <img src="/dreami-react-portfolio/assets/images/Stellar sonic.png" className="card-img-top" alt="stellar sonic" />
                    ...
                    <div className="col-sm-4 py-2">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <img src="/dreami-react-portfolio/assets/images/Screen Shot 2020-11-26 at 8.51.46 AM.png" className="card-img-top" alt="Eat da Burger" />
                    ...
                    <div className="col-sm-4 py-2">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <img src="/dreami-react-portfolio/assets/images/Screen Shot 2020-11-26 at 8.55.24 AM.png" className="card-img-top" alt="Employee Tracker" />
                    ...
                    <div className="col-sm-4 py-2">
                        <div className="card h-100">
                            <div className="card-body">
                                ...
                                <img src="/dreami-react-portfolio/assets/images/Screen Shot 2020-08-11 at 7.13.40 PM copy.png" className="card-img-top" alt="Template generator" />
